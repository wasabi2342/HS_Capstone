    ...
    public static class GUIHelper
    {
        ...
        public static void DisplayMessage(string message, bool big = false)
        {
            ...
            GUILayout.Label(message,
                big
                    ? GrabbitEditor.CurrentSettings.FontMarginStyleBig
                    : GrabbitEditor.CurrentSettings.Rich);
        ...
        {
            var prev = condition;
            GUILayout.BeginHorizontal(GrabbitEditor.CurrentSettings.MarginStyle);
            ...
            int maxValue = int.MaxValue)
        {
            ...
            var prev = value;
            value = EditorGUILayout.IntField(name, value, GrabbitEditor.CurrentSettings.NumberMarginStyle);
            ...
            float max = float.MaxValue)
        {
            ...
            value = EditorGUILayout.FloatField(name, value, GrabbitEditor.CurrentSettings.NumberMarginStyle);
